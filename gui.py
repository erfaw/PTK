...
class Gui(Tk):
    def __init__(self):
        ...
        titr_label_1 = Label(text= "Enter name of the program:", font= self.base_font, bg= "gray")
        titr_label_1.grid()
        ...
        titr_label_2 = Label(text= "Enter target time (e.g., 11:00 PM): ", font= self.base_font, bg= "gray")
        titr_label_2.grid()
        ...
        accept_btn = Button(text= "Agree", width= 51, command= self.accept_btn_clicked)
        accept_btn.grid()
